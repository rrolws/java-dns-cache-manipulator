...
[![Build Status](https://img.shields.io/appveyor/ci/alibaba/java-dns-cache-manipulator.svg?label=windows%20build)](https://ci.appveyor.com/project/oldratlee/java-dns-cache-manipulator/history)
